...
Se creó la columna **Facturación_Total** sumando el precio del producto y el costo de envío.  
Esto permite evaluar el desempeño económico total de las ventas.

La facturación total analizada fue de **$4,638,316,200**.

---

###  Categorías con mayor facturación

1. **Electrónicos** — $1,749,039,000
2. **Electrodomésticos** — $1,395,147,000
3. **Muebles** — $798,111,400

Estas categorías representan la mayor parte de los ingresos, destacándose especialmente los productos tecnológicos.

---

###  Ciudades con mayor volumen de compras

La ciudad con mayor facturación fue:

**Bogotá** — $1,911,588,000

Le siguen Medellín y Cali, lo que sugiere concentración de ventas en grandes capitales urbanas.

---

###  Vendedor con mayor facturación

El vendedor con mayor facturación fue **Felipe Santos**, obteniendo un total de **$372,652,300**.

Este resultado lo posiciona como el **vendedor más rentable** dentro del período analizado.
